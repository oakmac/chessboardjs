...
class Chessboard {
  ...
  #buildBoardHTML(orientation) {
    ...
    for (let i = 0; i < 8; i++) {
      ...
      for (let j = 0; j < 8; j++) {
        ...
        html += '<div class="{square} ' + ClassNameLookup[squareColor] + ' ' +
          'square-' + square + '" ' +
  ...
  #animateSquareToSquare(src, dest, piece, completeFn) {
    ...
    animation.onfinish = () => {
      ...
      destSquare.replaceChildren(pieceEl);
  ...
  #drawBoard() {
    ...
    if (this.#config.sparePieces) {
      ...
      if (this.#currentOrientation === 'white') {
        /** @type {HTMLElement} */(this.#sparePiecesTop).append(...spareBlackPieces);
        /** @type {HTMLElement} */(this.#sparePiecesBottom).append(...spareWhitePieces);
      } else {
        /** @type {HTMLElement} */(this.#sparePiecesTop).append(...spareWhitePieces);
        /** @type {HTMLElement} */(this.#sparePiecesBottom).append(...spareBlackPieces);
      }
    }
  }
