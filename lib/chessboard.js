...
;(function () {
  ...
  CSS['colorPieces'] = 'color-pieces-7492d'
  ...
  function constructor (containerElOrString, config) {
    ...
    function buildPieceHTML (piece, hidden, id) {
      ...
      if (piece === piece.toLowerCase()) {
        html += '<div '
        html += 'style="margin: 5px; background-color: ' + piece + '; display: inline-block; height: 45px; width: 45px;"' +
          'data-piece="' + piece + '" ' +
          'class="' + CSS.colorPieces + '" ' +
          'id="' + id + '"></div> '
      } else {
    ...
    function buildSparePiecesHTML (color) {
      ...
      var colorPieces = ['red', 'yellow', 'green', 'orange', 'blue']
      ...
      html += '<br>'
      for (var y = 0; y < colorPieces.length; y++) {
        sparePiecesElsIds[colorPieces[y]] = colorPieces[y] + '-' + uuid()
        html += buildPieceHTML(colorPieces[y], false, sparePiecesElsIds[colorPieces[y]])
      }
      html += '<p>arrows here</p>'
    ...
    function beginDraggingPiece (source, piece, x, y) {
      ...
      // $draggedPiece.attr('data-piece', piece).css({
      console.log(piece)
      console.log(source)
    ...
    widget.resize = function () {
      ...
      // spare pieces
      if (config.sparePieces) {
        console.log($container.find('.' + CSS.sparePieces).css('paddingLeft', squareSize + boardBorderSize + 'px'))
        $container
    ...
    function addEvents () {
      ...
      $container.on('mousedown', '.' + CSS.colorPieces, mousedownSparePiece)
      console.log(CSS.sparePieces)
      console.log(CSS.colorPieces)
      ...
      if (isTouchDevice()) {
        ...
        $container.on('touchstart', '.' + CSS.colorPieces, touchstartSparePiece)
        $window
