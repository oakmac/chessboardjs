  ...
  function constructor (containerElOrString, config) {
    ...
    function drawPositionInstant () {
      ...
      for (var i in currentPosition) {
        if (!Object.prototype.hasOwnProperty.call(currentPosition, i)) continue
    ...
    function isXYOnSquare (x, y) {
      for (var i in squareElsOffsets) {
        if (!Object.prototype.hasOwnProperty.call(squareElsOffsets, i)) continue
    ...
    function captureSquareOffsets () {
      ...
      for (var i in squareElsIds) {
        if (!Object.prototype.hasOwnProperty.call(squareElsIds, i)) continue
    ...
    function mousedownSquare (evt) {
      ...
      if (!Object.prototype.hasOwnProperty.call(currentPosition, square)) return
    ...
    function mouseenterSquare (evt) {
      ...
      var piece = false
      if (Object.prototype.hasOwnProperty.call(currentPosition, square)) {
